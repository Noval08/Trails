...
def startup():
    text = "RUK JA LONDU START HONE DE"
    ...
    print(f"\n{NEON_PINK}BAS HO GAYA BHAI🪄{RESET}")

def loader():
    print(f"{NEON_PURPLE}\n◆ CHAL FOLLOWERS DALNA KA LIYA READY◆{RESET}")
...
expiry_date = datetime(2026, 6, 16, 18, 00, 59)
now = datetime.now()

if now > expiry_date:
    print("\033[1;91m❌ CHAL BKL TOOL BUY KAR @SENSELESSME SA!\033[0m")
    sys.exit()

print("\033[1;92m✅ WELCOME BABU 💋!\033[0m")
...
print(f"{NEON_PURPLE}{BOLD}⠀⠀⠀⠀⠀⠀⢀⡀⠀⠀⠀⠀⠀⠀⣾⡳⣼⣆⠀⠀⢹⡄⠹⣷⣄⢠⠇⠻⣷⣶⢀⣸⣿⡾⡏⠀⠰⣿⣰⠏⠀⣀⡀⠀⠀⠀⠀⠀⠀⠀{RESET}")
print(f"{NEON_PURPLE}{BOLD}⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⡀⣀⣀⣀⡹⣟⡪⢟⣷⠦⠬⣿⣦⣌⡙⠿⡆⠻⡌⠿⣦⣿⣿⣿⣿⣦⣿⡿⠟⠚⠉⠀⠉⠳⣄⡀⠀⠀⠁⠀{RESET}")
print(f"{NEON_PURPLE}{BOLD}⠀⠀⠀⠀⠀⠀⠀⡀⢀⣼⣟⠛⠛⠙⠛⠉⠻⢶⣮⢿⣯⡙⢶⡌⠲⢤⡑⠀⠈⠛⠟⢿⣿⠛⣿⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⣆⠀⠀⠀{RESET}")
print(f"{NEON_PURPLE}{BOLD}⠀⠀⠀⠀⠀⡸⠯⣙⠛⢉⣉⣙⣿⣿⡳⢶⣦⣝⢿⣆⠉⠻⣄⠈⢆⢵⡈⠀⠀⢰⡆⠀⣼⠓⠀⠀⠀          𝐍𝐎𝐕𝐀𝐋 𝐃𝐀𝐃𝐃𝐘          ⠀⠀⠀⠈⣷⠀⠀{RESET}")
print(f"{NEON_PURPLE}{BOLD}⠀⠀⠀⠖⠉⠻⣟⡿⣿⣭⢽⣽⣶⣈⢛⣾⣿⣧⠀⠙⠓⠀⠑⢦⡀⠹⣧⢂⠀⣿⡇⢀⣿⠺⠇⠀                         ⠀⣿⠀⠀{RESET}")
print(f"{NEON_PURPLE}{BOLD}⠀⠀⠀⠀⠐⠈⠉⢛⣿⣿⣶⣤⣈⠉⣰⣗⡈⢛⣇⠀⣵⡀⠀⠘⣿⡄⢻⣤⠀⢻⡇⣼⣧⣿⠀                         ⡿⠀⠀{RESET}")
print(f"{NEON_PURPLE}{BOLD}⠀⠀⠀⠀⠀⣠⣾⣿⢍⡉⠛⠻⣷⡆⠨⣿⣭⣤⣍⠀⢹⣷⡀⠀⠹⣿⡄⠈⠀⢿⠁⣿⣿⠏⠀⠀⠀                        ⠀⠀⠀⣇⠀⠀{RESET}")
print(f"{NEON_PURPLE}{BOLD}⠀⣿⣇⣠⣾⣿⣛⣲⣿⠛⠀⠀⢀⣸⣿⣿⣟⣮⡻⣷⣤⡙⢟⡀⠀⠙⢧⠀⠀⠎⠀⠉⠁⠰⣿⠀⠀                         ⠀⢀⡿⠀⠀{RESET}")
...
pr(f"\033[38;5;133m𝑻𝑶𝑶𝑳 𝑩𝒀 @𝑺𝑬𝑵𝑺𝑬𝑳𝑬𝑺𝑺𝑴𝑬 || @𝑵𝑶𝑽𝑨𝑳𝑷𝑶𝑹𝑻𝑨𝑳")
pr(_E)
...
def pass_reset(fr):
    ...
    try:
        ...
        temp=data[param_key]
        temp=temp.replace('1453',fr)   # düzeltildi
        data[param_key]=temp
...
⠛⠒⠛⠉⠉⠀⠀⠀⣴⠟⢃⡴⠛⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠛⠛⠋⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
𝑻𝑶𝑶𝑳 𝑶𝑵 𝑷𝑳𝑬𝑨𝑺𝑬 𝑴𝑨𝑲𝑬 𝑺𝑼𝑹𝑬 𝑱𝑶𝑰𝑵 @𝑵𝑶𝑽𝑨𝑳𝑷𝑶𝑹𝑻𝑨𝑳
━━━━━━━━━━━━━━━━━━━━━━
"""
    R.post(
...
{NEON_GREEN}━━━━━━━━━━━━━━━━━━━━━━━{RESET}
{BG_WHITE} ₍^. .^₎⟆{RESET}
{NEON_GREEN} Hits     : {cnt_hits}{RESET}
{NEON_ORANGE} Good IG  : {cnt_good}{RESET}
{DARK_ROSE} Bad IG   : {cnt_bad}{RESET}
{NEON_GREEN}━━━━━━━━━━━━━━━━━━━━━━━{RESET}
...
def gen_token():
    try:
        ...
        h={_J:_B,_C:'ar-IQ,ar;q=0.9,en-IQ;q=0.8,en;q=0.7,en-US;q=0.6',_Q:ctype_val2,_K:'1',_F:str(GA())}
        ...
        token=str(resp.text).split('",null,"')[1].split('"')[0]
...
📸 𝗣𝗼𝘀𝘁𝘀 > {posts}
📝 𝗕𝗶𝗼 > {bio}
🔄 𝗥𝗲𝘀𝗲𝘁 > {reset_cmd(user)}
✅ 𝗠𝗲𝘁𝗮 > Yes
🔗 𝗣𝗿𝗼𝗳𝗶𝗹𝗲 > https://www.instagram.com/{user}/
...
{SKY_BLUE}━━━  ━━━━
{NEON_PINK}━━━━━━━━━━━━━━━━━━━━━
1) ARAM SA LEKIN GOOD HIT
2) FAST LEKIN PATA NHI
{DEEP_PURPLE}━━━━━━━━━━━━━━━━━━━━━
RECOMMENDED 1ST
{SKY_BLUE}━━━━━━━━━━━━━━━━━━━━━{RESET}""")

opt = input(f"{MIDNIGHT}Select option: {RESET}")
...
if opt == "1":
    ...
    print(f"""{WHITE}
━━━━━━━━━━━━━━━━━━━━━
{NEON_PINK}✦ CHAL HIT DEKH ✦  
{MIDNIGHT}━━━━━━━━━━━━━━━━━━━━━{RESET}
""")
else:
    print(f"{SOFT_PINK}Invalid → default SINGLE MODE{RESET}")
    delay = 0.2

speed_txt = "NO DELAY" if delay == 0 else str(delay)
print(f"{DEEP_PURPLE}Speed: {speed_txt}{RESET}\n")
